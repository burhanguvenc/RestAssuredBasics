...
public class ECommerceAPITest {
	...
	public static void main(String[] args) {
		...
		loginRequest.setUserEmail("rebo@gmail.com");
		loginRequest.setUserPassword("Rebo2121");
		...
		.param("productPrice", "4299")
		.param("productDescription", "Lenova")
		.param("productFor", "men")
		.multiPart("productImage", new File("C:\\Users\\burha\\Downloads\\tshirt.jpg"));
